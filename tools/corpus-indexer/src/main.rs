...
use candidate_cache::{
    ...
    open_or_build_anchor_row_stream, target_hits_path, CacheBuildStats,
};
...
#[derive(Args)]
struct PhraseVariantStressArgs {
...
fn phrase_variant_stress(args: PhraseVariantStressArgs) -> Result<()> {
