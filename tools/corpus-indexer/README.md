...
- `.cache/corpus-candidate-shards/v1`: optional parsed candidate cache.
...
- `build-candidate-cache`: parse raw resources once into zstd JSONL candidate
  shards for faster repeat scans.
